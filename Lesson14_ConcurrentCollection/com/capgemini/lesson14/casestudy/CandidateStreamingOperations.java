package com.capgemini.lesson14.casestudy;
...
public class CandidateStreamingOperations {
	...
	public static void main(String[] args) {
		...
		List<Candidate> puneCandidates = InterviewRepository.getCandidateList()
				.stream().filter((candidate)-> candidate.getCity().equals("Pune"))
		...
		Map<String,List<Candidate>> cityCount = InterviewRepository.getCandidateList()
				.stream().collect(Collectors.groupingBy((student)->student.getCity()));
		...
		Map<String,List<Candidate>> techCount = InterviewRepository
				.getCandidateList().stream().collect(Collectors.groupingBy
